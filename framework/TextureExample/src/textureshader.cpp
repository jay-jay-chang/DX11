...
bool TextureShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, defines, D3D_COMPILE_STANDARD_FILE_INCLUDE, "TextureVertexShader", "vs_4_0", flags, 0,
	...
	result = D3DCompileFromFile(psFilename, defines, D3D_COMPILE_STANDARD_FILE_INCLUDE, "TexturePixelShader", "ps_4_0", flags, 0,
